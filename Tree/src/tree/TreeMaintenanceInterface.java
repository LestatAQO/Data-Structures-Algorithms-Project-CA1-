 ...
 */
//I used the contents of week 3 https://moodle2025.ncirl.ie/course/section.php?id=40624 as reference, mainly the PriorityQueueExample and the ppt.
public interface TreeMaintenanceInterface {
    //Same as previous interfaces.
    public void newTask(int priority, String task); //indicate sthe priority of the task and has the description of such task.
    ...
    public String displayTasks(); //Displays the tasks.
}
